...
public class UsuarioService {
    ...
    private PasswordEncoder passwordEncoder;
     ...
     // Salva um usuário no MongoDB.
     // Criptografa a senha antes de salvar para garantir a segurança.
    ...
    public String salvarUsuario(Usuario usuario) {
        ...
        // possibilita que o usuário tenha role definida (opcional)
    ...
    public void criarFuncionarioPadrao() {
        ...
        funcionario.setUsuario("atlus"); // login do funcionario
        funcionario.setSenha("teste1280"); // senha do funcionario
