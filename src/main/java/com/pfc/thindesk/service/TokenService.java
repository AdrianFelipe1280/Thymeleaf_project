...
public class TokenService {
    ...
    private static final String SECRET = "persona";
    ...
    public String gerarToken(Usuario usuario) {
        return JWT.create()
                ...
                .withClaim("role", usuario.getRole().name()) // role no dentro do token
                .withIssuedAt(new Date())                 // data de criacao
    ...
    public String validarToken(String token) {
        return JWT.require(Algorithm.HMAC256(SECRET))
                .withIssuer("adrian") // valida que o token foi emitido por você
                .build()
                .verify(token)
                .getSubject();
    }
    ...
    public String recoverClaim(String token, String claimName) {
        try {
            // Decodifica o token sem validá-lo (para extrair os valores do claims)
